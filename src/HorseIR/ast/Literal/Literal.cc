...
Literal::Literal(antlr4::tree::ParseTree *cst, ASTNode::MemManagerType &mem, Literal::LiteralClass p_literalClass,
                 ASTNode::ASTNodeType type)
    : literalClass(p_literalClass),
      ASTNode(cst, mem, type)
{}

Literal::Literal(ASTNode::MemManagerType &mem, Literal::LiteralClass p_literalClass, ASTNode::ASTNodeType type)
    : literalClass(p_literalClass),
      ASTNode(mem, type)
{}
