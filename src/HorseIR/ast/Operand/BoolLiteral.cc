...
BoolLiteral::BoolLiteral(ASTNode* parent, HorseIRParser::LiteralCaseBoolContext *cst, ASTNode::MemManagerType &mem)
    : Literal(parent, cst, mem, Literal::LiteralClass::BoolLiteral, ASTNode::ASTNodeClass::BoolLiteral)
{
