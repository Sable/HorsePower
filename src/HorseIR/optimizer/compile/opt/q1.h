...
L q1_peephole_0(V *z, V y, V *x){
    ...
    initV(z4,vp(x4),lenZ);
    initV(z5,vp(x5),lenZ);
    DOT(len, if(vB(y,i)){L c=offset[tid]++;vE(z0,c)=vE(x0,i);vE(z1,c)=vE(x1,i);vE(z2,c)=vE(x2,i);vE(z3,c)=vE(x3,i);vC(z4,c)=vC(x4,i);vC(z5,c)=vC(x5,i);})
}
...
E compiledQ1(){
    ...
    V t17 = allocNode(); V t27 = allocNode(); V t35 = allocNode(); V t39 = allocNode();
    V t40 = allocNode(); V t41 = allocNode(); V t42 = allocNode(); V t43 = allocNode();
    V t44 = allocNode(); V t45 = allocNode(); V t46 = allocNode(); V t47 = allocNode();
    V t48 = allocNode(); V t49 = allocNode(); V t50 = allocNode(); V t51 = allocNode();
    V t52 = allocNode(); V t53 = allocNode(); V t54 = allocNode(); V t55 = allocNode();
    V t56 = allocNode(); V t57 = allocNode(); V t58 = allocNode(); V t59 = allocNode();
    ...
    V t87 = allocNode(); V t22 = allocNode(); V t23 = allocNode(); V t24 = allocNode();
    V t25 = allocNode(); V t26 = allocNode();
    V t34 = allocNode(); V t36 = allocNode(); V t37 = allocNode(); V t38 = allocNode();
    //V k0[] = {t22,t23,t24,t25,t26,t27};
    //V k1[] = {t5,t6,t7,t8,t9,t10};
    //V k2[] = {t23,t24};
    //V k3[] = {t23,t24,t25};
    //V k4[] = {t26,t27}, k5[] = {t44 ,t45};
    //B k6[] = {1,1};
    //S k7[] = {"l_returnflag","l_linestatus","sum_qty","sum_base_price","sum_disc_price","sum_charge","avg_qty","avg_price","avg_disc","count_order"};
    //V k8[] = {t75 ,t76 ,t77 ,t78 ,t79 ,t80 ,t81 ,t82 ,t83 ,t84};
    tic;
    ...
    PROFILE(  8, t17, pfnLeq(t17, t11, initLiteralDate(19980902))); // type
    if(OPT_PH){
        PROFILE(  9, t27, q1_peephole_0((V []){t22,t23,t24,t25,t26,t27},t17,(V []){t5,t6,t7,t8,t9,t10}));
    }
    else {
        PROFILE(  9, t22, pfnCompress(t22, t17, t5));
        PROFILE( 10, t23, pfnCompress(t23, t17, t6));
        PROFILE( 11, t24, pfnCompress(t24, t17, t7));
        PROFILE( 12, t25, pfnCompress(t25, t17, t8));
        PROFILE( 13, t26, pfnCompress(t26, t17, t9));
        PROFILE( 14, t27, pfnCompress(t27, t17, t10));
    }
    if(OPT_LF){
        ...
        PROFILE( 15, t34, pfnMinus(t34, initLiteralI64(1), t24));
        PROFILE( 16, t35, pfnMul(t35, t23, t34));
        PROFILE( 17, t36, pfnPlus(t36, initLiteralI64(1), t25));
        PROFILE( 18, t37, pfnMinus(t37, initLiteralI64(1), t24));
        PROFILE( 19, t38, pfnMul(t38, t23, t37));
        PROFILE( 20, t39, pfnMul(t39, t38, t36));
    }
    ...
    if(OPT_PH){
        PROFILE( 41, t72, q1_peephole_2(t72, t26, t43));
    }
    else {
        PROFILE( 39, t70, pfnEachRight(t70,t26,t43,pfnIndex));
        PROFILE( 40, t71, pfnEach(t71,t70,pfnLen));
        PROFILE( 41, t72, pfnRaze(t72, t71));
    }
    PROFILE( 42, t73, pfnList(t73, 2, (V []){t44 ,t45}));
    PROFILE( 43, t74, pfnOrderBy(t74, t73, initLiteralBoolVector(2, (B []){1,1})));
    PROFILE( 44, t75, pfnIndex(t75, t44, t74));
    PROFILE( 45, t76, pfnIndex(t76, t45, t74));
    PROFILE( 46, t77, pfnIndex(t77, t48, t74));
    PROFILE( 47, t78, pfnIndex(t78, t54, t74));
    PROFILE( 48, t79, pfnIndex(t79, t60, t74));
    PROFILE( 49, t80, pfnIndex(t80, t63, t74));
    PROFILE( 50, t81, pfnIndex(t81, t51, t74));
    PROFILE( 51, t82, pfnIndex(t82, t57, t74));
    PROFILE( 52, t83, pfnIndex(t83, t69, t74));
    PROFILE( 53, t84, pfnIndex(t84, t72, t74));
    PROFILE( 54, t85, copyV(t85, initLiteralSymVector(10, (S []){"l_returnflag","l_linestatus","sum_qty","sum_base_price","sum_disc_price","sum_charge","avg_qty","avg_price","avg_disc","count_order"})));
    PROFILE( 55, t86, pfnList(t86, 10, (V []){t75 ,t76 ,t77 ,t78 ,t79 ,t80 ,t81 ,t82 ,t83 ,t84}));
    PROFILE( 56, t87, pfnTable(t87, t85, t86));
    toc;
    printV(t87);
    R elapsed;
}
