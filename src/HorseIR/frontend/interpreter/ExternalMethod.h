...
template <typename T>
inline horseIR::interpreter::ExternalMethod<T>*
horseIR::interpreter::ExternalMethod<T>::bindExternalMethod(
...
template <typename T>
inline horseIR::interpreter::__ExternalMethodLambda<T>::__ExternalMethodLambda(
    const std::string& p_moduleName,
    const std::string& p_methodName,
    const std::string& p_signatureString,
    const std::function<T(std::size_t, T[])>& func)
    : horseIR::interpreter::ExternalMethod<T>(p_moduleName, p_methodName, p_signatureString),
    wrapFunc(func)
{}
...
inline horseIR::interpreter::__ExternalMethodLambda<T>::__ExternalMethodLambda(
    ...
    const std::function<T(std::size_t, T[])>& func)
    : horseIR::interpreter::ExternalMethod<T>(p_moduleName, p_methodName, p_signatureType),
    wrapFunc(func)
{}

template <typename T>
inline T horseIR::interpreter::__ExternalMethodLambda<T>::invoke(std::size_t argc, T argv[]) const
{
