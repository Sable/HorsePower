...
macro(antlr4cpp_process_grammar
  ...
  file(MAKE_DIRECTORY ${ANTLR4CPP_GENERATED_SRC_DIR})
  execute_process(COMMAND "${Java_JAVA_EXECUTABLE}" -jar "${ANTLR4CPP_JAR_LOCATION}"
    -Werror -Dlanguage=Cpp -listener -visitor
    -o "${ANTLR4CPP_GENERATED_SRC_DIR}/${antlr4cpp_project_namespace}"
    -package ${antlr4cpp_project_namespace}
    "${antlr4cpp_grammar_lexer}" "${antlr4cpp_grammar_parser}")
  ...
  foreach(generated_header ${generated_headers})
    list(APPEND antlr4cpp_src_headers_${antlr4cpp_project_namespace} ${generated_header})
  endforeach(generated_header)
  message(STATUS "Antlr4Cpp  ${antlr4cpp_project_namespace} Sources: ${generated_files}")
  message(STATUS "Antlr4Cpp  ${antlr4cpp_project_namespace} Headers: ${generated_headers}") 
