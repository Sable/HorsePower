...
E compiled_main(){
    ...
    //getInfoVar(t15); getInfoVar(t17); getchar();
    //PROFILE(  7, t18, pfnMember(t18, t17, t15));
    PROFILE(  7, t18, pfnMember(t18, t15, t17));
    //L tot2=0; DOI(vn(t18), tot2+=vB(t18,i)) P("tot2 = %lld\n",tot2); getchar();
    PROFILE(  8, t26, q12_loopfusion_0(t26,(V []){t13,t18,t12,t11}));
    //L tot=0; DOI(vn(t26), tot+=vB(t26,i)) P("tot = %lld\n",tot); getchar();
    ...
    if(false){
        ...
        //getInfoVar(t26); getInfoVar(t53); getInfoVar(t15); getInfoVar(t49); getchar();
    ...
    // expected size: 30988
    // getInfoVar(t70); getInfoVar(t78); getchar();
