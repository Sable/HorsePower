...
L q19_loopfusion_2(V z, V *x){
    ...
    DOP(vn(x0), vB(z,i)=AND(AND(AND(GEQ(vLL(x0,i),1),LEQ(vLL(x0,i),5)),EQ(vQ(x1,i),id0)),vB(x2,i))) R 0;
}
/* num_func = 2, targ = t30 */
...
L q19_loopfusion_4(V z, V *x){
    ...
    DOP(vn(x0), vB(z,i)=AND(AND(AND(GEQ(vLL(x0,i),1),LEQ(vLL(x0,i),10)),EQ(vQ(x1,i),id0)),vB(x2,i))) R 0;
}
/* num_func = 6, targ = t78 */
L q19_loopfusion_5(V z, V *x){
    ...
    DOP(vn(x0), vB(z,i)=AND(AND(AND(GEQ(vLL(x0,i),1),LEQ(vLL(x0,i),15)),EQ(vQ(x1,i),id0)),vB(x2,i))) R 0;
}
...
L q19_peephole_0(V *z, V y, V *x){
    ...
    initV(z2,vp(x2),lenZ);
    initV(z3,vp(x3),lenZ);
    DOT(len, if(vB(y,i)){L c=offset[tid]++;vLL(z0,c)=vLL(x0,i);vE(z1,c)=vE(x1,i);vE(z2,c)=vE(x2,i);vE(z3,c)=vE(x3,i);}) R 0;
}
...
E compiled_main(){
    ...
    PROFILE( 13, t28, pfnMember(t28, t25, t27));
    //seeVectorB(t28);
    ...
    PROFILE( 17, t52, pfnMember(t52, t7, t51));
    //seeVectorB(t52);
    ...
    PROFILE( 20, t63, pfnMember(t63, t7, t62));
    //seeVectorB(t63); getchar();
