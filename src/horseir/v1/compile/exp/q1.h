...
L q1_combine_0(V *z, V y, V *x){
    ...
    // Output: compress rate: 98.5899% = 5916591/6001215
    // Comment: so the operation compress is very costly
...
L q1_peephole_1(V *z, V *x, V y){
    ...
    initV(z5, H_E, r0);
    initV(z6, H_E, r0);
    // r0 = 4, vn(t)= 1478493,38854,2920374,1478870
...
E compiledQ1(){
    ...
    PROFILE( 11, t27, q1_combine_0((V []){t22,t23,t24,t26,t27,t35,t39},t17,(V []){t5,t6,t7,t8,t9,t10}));   // expensive 1
    ...
    PROFILE( 38, t69, q1_peephole_1((V []){t48,t51,t54,t57,t60,t63,t69}, (V []){t22,t22,t23,t23,t35,t39,t24}, t43)); // expensive 2
